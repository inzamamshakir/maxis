      ...
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, BIG_INT_ZERO) ? (
        ...
        <LightCard>
          <Text fontSize="14px" style={{ textAlign: 'center' }}>
            ...
            {t(
              'By providing liquidity to the pool, you have the opportunity to earn a 0.25% share of all trades made on this specific pair. The amount you earn is proportional to your contribution to the liquidity pool. As trades occur, fees generated from these transactions are automatically added to the pool. These fees accumulate in real time and can be claimed whenever you decide to withdraw your liquidity.',
            )}
          </Text>
        </LightCard>
      )}
