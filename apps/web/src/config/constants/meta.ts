...
export const DEFAULT_META: PageMeta = {
  title: 'Maxi Swap Multi-chain DeFi ecosystem, Swap, Bridge, LaunchPad',
  description:
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/farms': { title: t('Farms') },
      '/pools': { title: t('Pools') },
      '/info': { title: t('Overview'), description: 'View statistics for Maxi Swap exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for Maxi Swap exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for Maxi Swap exchanges.' },
      '/core': { basePath: true, title: t('Get Ready for Core 🚀') },
      '/bridge': {
        basePath: true,
        title: t('Bridge'),
        description: 'Transfer tokens between multiple Chains like Core and many more on MaxiSwap DEX.',
      },
    },
    defaultTitleSuffix: t('Maxi Swap'),
  }
}
