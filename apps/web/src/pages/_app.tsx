  ...
  return (
    <>
      <Head>
        ...
        />
        <meta name="theme-color" content="#4e32a1" />
        ...
        <meta
          name="twitter:title"
          content="Maxi Swap - Trade, Earn, Bridge and Launch on CORE, XDC, Binance smart chain (BSC), Bitgert (Brise), Dogechain, Doken and Fuse via our decentralized Smart contracts."
        />
        <title>Maxi Swap</title>
      </Head>
      <main>
