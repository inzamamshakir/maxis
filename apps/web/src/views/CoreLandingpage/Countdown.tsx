...
const coreReleaseDate = new Date('2024-02-09T00:00:00.000Z')
      ...
      >
        <Flex flex="1" flexDirection="column">
          ...
          <Heading scale="md" mb="24px" as="p" lineHeight="120%">
            Maxi Swap will be supporting the{' '}
            <Link display="inline-flex" href="https://coredao.org/">
              Core Chain
            </Link>{' '}
            from the start on. Maxi Swap offers a seamless trading experience for digital assets on Core with our
