...
import Bannerbgmaxi from '../../../../../public/images/New/bannerbgimg.jpg'
    ...
    >
      <S.Inner>
        <S.LeftWrapper position="relative" style={{ zIndex: 2 }}>
          ...
          <Header>
            {isMobile
              ? t('MaxiSwap Empowering Decentralized Exchange')
              : t('Discover the future of Decentralized Finance with MAXI Swap')}
          </Header>
          <StyledSubheading>
            {isDesktop && t('Empowering Decentralized Exchange for the new Era of Finance')}
          </StyledSubheading>
          <Flex alignItems="center" style={{ gap: isMobile ? 4 : 16 }}>
            <Link href="https://test.maxiswap.org/404" style={{ textDecoration: 'none' }} external>
              <StyledButton variant="text" scale={isMobile ? 'sm' : 'md'} style={{ color: 'white', paddingLeft: 0 }}>
                {t('Details')}
              </StyledButton>
            </Link>
            <Devider />
            <Link href="https://test.maxiswap.org/404" external style={{ textDecoration: 'none' }}>
        ...
        <RightWrapper>
          {!isMobile ? (
            <Image src={BannerMaxiImg5} alt="pancakeProtectorBunny" width={193} height={232} unoptimized />
          ) : (
            <Image src={BannerMaxiImg5} alt="pancakeProtectorBunnyMobile" width={132} height={160} unoptimized />
          )}
          <BGWrapper>
            {!isMobile ? (
              <Image src={Bannerbgmaxi} alt="pancakeProtectorBg" width={1126} height={192} unoptimized />
            ) : (
              <Image src={Bannerbgmaxi} alt="pancakeProtectorBgMobile" width={293} height={176} unoptimized />
            )}
          </BGWrapper>
        </RightWrapper>
      </S.Inner>
