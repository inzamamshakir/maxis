...
const TradingRewardBanner = () => {
  ...
  return (
    <S.Wrapper
      style={{
        background:
          'linear-gradient(64.41deg, rgb(0 176 255 / 19%) 44.37%, rgb(177 85 255 / 0%) 102.8%), radial-gradient(55.22% 134.13% at 57.59% 0%, rgb(224 95 255) 0%, rgb(174 53 255) 33.21%, rgb(96 27 112) 79.02%)',
      }}
    >
      <S.Inner>
        <S.LeftWrapper>
          ...
          <Flex flexDirection={['column', 'row']} mb={['8px', '8px', '12px']}>
            <Title>{t('Trade on Multichain with MaxiSwap!')}</Title>
          </Flex>
        ...
        <RightWrapper>
          {isMobile || isTablet ? (
            <Image src={BannerMaxiImg} alt="TradingRewardBunny" width={145} height={167} placeholder="blur" />
          ) : (
            <Image src={BannerMaxiImg} alt="TradingRewardBunny" width={220} height={249} placeholder="blur" />
          )}
          {isMobile ? (
            <Image src={BannerMaxiImg2} alt="TradingRewardButter" width={40} height={34} placeholder="blur" />
          ) : (
            <Image src={BannerMaxiImg2} alt="TradingRewardButter" width={72} height={60} placeholder="blur" />
          )}
          {isDesktop && (
            <>
              <Image src={BannerMaxiImg4} alt="TradingRewardButter2" width={100} height={80} placeholder="blur" />
